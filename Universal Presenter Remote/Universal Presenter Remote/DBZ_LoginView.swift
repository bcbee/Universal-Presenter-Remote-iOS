...
class DBZ_LoginView: UIViewController {
    ...
    @IBOutlet var QRSelector: UISegmentedControl!
    ...
    override func viewDidLoad() {
        ...
        center.addObserver(self, selector: #selector(resetQR(_:)), name: Notification.Name("ResetQR"), object: nil)
    ...
    @objc func resetQR(_ notification: Notification?) {
        QRSelector.selectedSegmentIndex = 0
    }
